...
$sql = "SELECT nombreSede FROM SEDES WHERE nombreSede LIKE 'Etec%'";
$result = mysqli_query($conexion,$sql);
$n=0;
while ($ver=mysqli_fetch_row($result)){
  $sedes= $ver[0];
}
$sql1 = "SELECT nombreDepar FROM DEPARTAMENTOS WHERE nombreDepar LIKE 'E-%'";
...
?>
<div id="graficoBarrasE"><div>

  <script type="text/javascript">
  function crearCadenaBarrasE(json){
...
datosX = crearCadenaBarrasE('<?php echo $datosX ?>');
datosY = crearCadenaBarrasE('<?php echo $datosY ?>');
...
Plotly.newPlot('graficoBarrasE', data, layout);
</script>
