  ...
  <script src="js/funcionesI.js"></script>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<label>Nombre</label>
						<input type="text" name="" id="nombre" class="form-control input-sm" placeholder="Ingrese el nombre" required oninvalid="this.setCustomValidity('Ingrese el nombre aqui')"
    oninput="this.setCustomValidity('')">
            <label>Interno</label>
            <input type="text" name="" id="inter" class="form-control input-sm" placeholder="Ingrese el interno" required oninvalid="this.setCustomValidity('Ingrese el interno aqui')"
    oninput="this.setCustomValidity('')">
            <!--<label>Sede</label>
    ...
    oninput="this.setCustomValidity('')">
            ...
            <input type="text" name="" id="deparI" class="form-control input-sm" placeholder="Ingrese el departamento">-->
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal" id="guardarnuevoI">
					Agregar
					</button>
	...
	<div class="modal fade" id="modalEdicionI" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-sm" role="document">
            ...
            <label>Nombre</label>
						<input type="text" name="" id="nombreu" class="form-control input-sm" placeholder="Ingrese el nombre" required oninvalid="this.setCustomValidity('Ingrese el nombre aqui')"
    oninput="this.setCustomValidity('')">
            <label>Interno</label>
            <input type="text" name="" id="interu" class="form-control input-sm" placeholder="Ingrese el interno" required oninvalid="this.setCustomValidity('Ingrese el interno aqui')"
    oninput="this.setCustomValidity('')">
            <!--<label>Sede</label>
