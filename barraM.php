...
$sql = "SELECT nombreSede FROM SEDES WHERE nombreSede LIKE 'Mendoza%'";
$result = mysqli_query($conexion,$sql);
$n=0;
while ($ver=mysqli_fetch_row($result)){
  $sedes= $ver[0];
}
$sql1 = "SELECT nombreDepar FROM DEPARTAMENTOS WHERE nombreDepar LIKE 'Mza-%'";
...
?>
<div id="graficoBarrasM"><div>

  <script type="text/javascript">
  function crearCadenaBarrasM(json){
...
datosX = crearCadenaBarrasM('<?php echo $datosX ?>');
datosY = crearCadenaBarrasM('<?php echo $datosY ?>');
...
Plotly.newPlot('graficoBarrasM', data, layout);
</script>
