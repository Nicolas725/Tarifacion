...
$sql = "SELECT nombreSede FROM SEDES WHERE nombreSede LIKE 'Rio Cuarto%'";
$result = mysqli_query($conexion,$sql);
$n=0;
while ($ver=mysqli_fetch_row($result)){
  $sedes= $ver[0];
}
$sql1 = "SELECT nombreDepar FROM DEPARTAMENTOS  WHERE nombreDepar LIKE 'RC-%'";
...
?>
<div id="graficoBarrasRC"><div>

  <script type="text/javascript">
  function crearCadenaBarrasRC(json){
...
datosX = crearCadenaBarrasRC('<?php echo $datosX ?>');
datosY = crearCadenaBarrasRC('<?php echo $datosY ?>');
...
Plotly.newPlot('graficoBarrasRC', data, layout);
</script>
